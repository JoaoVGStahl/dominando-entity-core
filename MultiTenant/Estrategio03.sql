...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Name', N'TenantId') AND [object_id] = OBJECT_ID(N'[dbo].[People]'))
...
VALUES (N'20220119134058_EstrategiaTenantSchema', N'5.0.3');
GO
...
EXEC(N'ALTER SCHEMA [' + @defaultSchema + N'] TRANSFER [dbo].[Products];');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220119160833_Estrategia03', N'5.0.3');
GO
